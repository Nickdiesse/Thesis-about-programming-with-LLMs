...
def retrieve_responses():
    ...
    cursor.execute("SELECT id, question, ground_truth, answer_llama, answer_orca, answer_falcon FROM qa_results")
...
def compare_responses_with_embeddings(results):
    ...
    for row in results:
        ...
        similarity_threshold = 0.5  # Valore arbitrario, si può sperimentare con diversi valori
