...
def create_table():
 ...
 # Creazione tabella (se non esiste)
    cursor.execute("""
    CREATE TABLE IF NOT EXISTS model_rag_responses (
        question_id INT,
    question_text TEXT,
    answer_llama TEXT,
    answer_orca TEXT,
...
def save_to_db(result):
    ...
    cursor.execute("""
        INSERT INTO model_rag_responses (question_id, question_text, answer_llama, answer_orca, answer_falcon, llama_time, orca_time, falcon_time)
...
pdf_index = create_pdf_index(r"C:\Users\nicol\Desktop\progetto_tesi\benchmark\pdf_animals")

# Caricamento delle domande dal file JSON
with open(r"C:\Users\nicol\Desktop\progetto_tesi\benchmark\animal_questions.json") as f:
